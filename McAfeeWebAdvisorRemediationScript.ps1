####### Remediation script ########
## Remediation Script to remove McAfee thoroughly
## Author: Ahad Alam
## Date: 17-April-2025
...
$McAfeeCleanZipUrl  = "https://raw.githubusercontent.com/Ahad-Cwan/McAfee_Removal_Script/main/mcafeeclean.zip"
$McCleanupZipUrl    = "https://raw.githubusercontent.com/Ahad-Cwan/McAfee_Removal_Script/main/mccleanup.zip"
...
switch ($status) {
    ...
    1 {
        Write-Log "Final detection: McAfee remnants still detected (registry entries or significant file count). Exiting with code 1 to trigger remediation reattempt." "WARNING"
        exit 1
    }
}
